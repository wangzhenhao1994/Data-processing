...
class FFT_ionS():
    ...
    def __init__(self, filename, scanTime, sampRate, massRange=[2, 50], molecule='H2', intensity = 0, dcRange=5, ChN=10, cal_mass=[2,44], cal_pixel=[270,7942]):
    ...
    #def __init__(self, filename, massRange=[5, 50], dcRange=2, cal_mass=[17,18], cal_pixel=[197,279]):
        ...
        self.delayD = np.arange(self.scanLengthD)/self.scanLengthD*100*2*2*3.33564*10**-15/4161.16632*4146.12
        self.gasBottle = {
    ...
    def read_splitB(self, isCorrection = False, sumN=10):
        ...
        #self.spectraBottleB['Ch'+str(2)] = self.spectraBottleB['Ch'+str(2)]-self.spectraBottleB['Ch'+str(0)]
        self.spectraBottleB['Ch'+str(6)] = self.spectraBottleB['Ch'+str(6)]-self.spectraBottleB['Ch'+str(0)]*20
        self.spectraBottleB['Ch'+str(4)] = self.spectraBottleB['Ch'+str(4)]-self.spectraBottleB['Ch'+str(10)]
        #self.spectraBottleB['Ch'+str(8)] = self.spectraBottleB['Ch'+str(8)]-self.spectraBottleB['Ch'+str(0)]
        self.spectraBottleB['Ch2+4+6+8'] = self.spectraBottleB['Ch'+str(2)]+self.spectraBottleB['Ch'+str(4)]+self.spectraBottleB['Ch'+str(6)]+self.spectraBottleB['Ch'+str(8)]+self.spectraBottleB['Ch'+str(0)]+self.spectraBottleB['Ch'+str(10)]
    ...
    def show_FFT(self):
        ...
        for gas in ['Ch2','Ch4','Ch6','Ch8','Ch0','Ch10']:
            ...
            #    continue
            #if self.ChN == 11:
            #    if gas not in ['Ch2','Ch4','Ch6','Ch8','Ch0','Ch10']:
            #        continue
    ...
    def show_Spectra(self, shift=0):
        ...
        lab=['Mass 16','Mass 22','Mass 28','Mass 44','ref28','ref22']#'ref16','ref22']
        i=0
        if ifsaveT:
        ...
        for gas in ['Ch2','Ch4','Ch6','Ch8','Ch0','Ch10']:
            ...
            if gas == 'Ch10':
                ax.plot(delay*10**15+shift,
                     self.spectraBottleB["window_"+'Ch2']/np.abs(np.amax(self.spectraBottleB["window_"+'Ch2'])), label='Ch2')#/np.amax(self.spectraBottleB[gas])
                ax.plot(delay*10**15+shift,
                     self.spectraBottleB["window_"+'Ch4']/np.abs(np.amax(self.spectraBottleB["window_"+'Ch4'])), label='Ch4')#/np.amax(self.spectraBottleB[gas])
                ax.plot(delay*10**15+shift,
                     self.spectraBottleB["window_"+'Ch6']/np.abs(np.amax(self.spectraBottleB["window_"+'Ch6'])), label='Ch6')#/np.amax(self.spectraBottleB[gas])
            else:
                ax.plot(delay*10**15+shift,
...
if __name__ == '__main__':
    ...
    #CO2
    f3 = [r'scan_tof_2022-07-27-12-17-05 - Copy'] #230-230
    f4 = [r'scan_tof_2022-07-27-13-30-56 - Copy'] #150-150
    f5 = [r'scan_tof_2022-07-27-13-30-56 - Copy'] #180-180
    f6 = [r'scan_tof_2022-07-27-15-14-22'] #260-1
    f7 = [r'scan_tof_2022-07-27-18-33-55'] #250-70
    f8 = [r'scan_tof_2022-07-28-11-10-28 - Copy'] #210-70
    f9 = [r'scan_tof_2022-07-28-14-07-58'] #170-70
    f10 = [r'scan_tof_2022-07-28-17-18-03'] #170-120
    f12 = [r'scan_tof_2022-07-29-09-52-06'] #170-210
    f13 = [r'scan_tof_2022-07-29-11-23-24'] #170-250
    f14 = [r'scan_tof_2022-07-29-13-10-14'] #70-250
    f15 = [r'scan_tof_2022-07-29-14-48-30'] #70-210
    f16 = [r''] #70-170
    f17 = [r'scan_tof_2022-07-29-17-42-30'] #250-270

    #20220820
    f18 = [r'scan_tof_2022-08-20-11-15-01'] #260-230
    f19 = [r'scan_tof_2022-08-21-09-58-31'] #250-110
    ...
    f4 = FFT_ionS(filename=f4, scanTime=10, sampRate=300, molecule='H2', intensity=cal_intensity(150,12,5),ChN=11)
    f5 = FFT_ionS(filename=f5, scanTime=10, sampRate=300, molecule='H2', intensity=cal_intensity(180,10.5,5),ChN=11)
    f6 = FFT_ionS(filename=f6, scanTime=10, sampRate=300, molecule='H2', intensity=cal_intensity(260,9,5),ChN=11)
    f7 = FFT_ionS(filename=f7, scanTime=10, sampRate=300, molecule='H2', intensity=cal_intensity(250,9,5),ChN=11)
    f8 = FFT_ionS(filename=f8, scanTime=10, sampRate=300, molecule='H2', intensity=cal_intensity(210,10,5),ChN=11)
    f9 = FFT_ionS(filename=f9, scanTime=10, sampRate=300, molecule='H2', intensity=cal_intensity(170,11.5,5),ChN=11)
    f10= FFT_ionS(filename=f10, scanTime=10, sampRate=300, molecule='H2', intensity=cal_intensity(170,11.5,5),ChN=11)
    f12= FFT_ionS(filename=f12, scanTime=10, sampRate=300, molecule='H2', intensity=cal_intensity(170,11.5,5),ChN=11)
    f13= FFT_ionS(filename=f13, scanTime=10, sampRate=300, molecule='H2', intensity=cal_intensity(170,11.5,5),ChN=11)
    f14= FFT_ionS(filename=f14, scanTime=10, sampRate=300, molecule='H2', intensity=cal_intensity(170,11.5,5),ChN=11)
    f15= FFT_ionS(filename=f15, scanTime=10, sampRate=300, molecule='H2', intensity=cal_intensity(170,11.5,5),ChN=11)
    f17= FFT_ionS(filename=f17, scanTime=10, sampRate=300, molecule='H2', intensity=cal_intensity(170,11.5,5),ChN=11)
    f18= FFT_ionS(filename=f18, scanTime=10, sampRate=300, molecule='H2', intensity=cal_intensity(170,11.5,5),ChN=11)
    f19= FFT_ionS(filename=f19, scanTime=10, sampRate=300, molecule='H2', intensity=cal_intensity(110,14.2,5),ChN=11)
