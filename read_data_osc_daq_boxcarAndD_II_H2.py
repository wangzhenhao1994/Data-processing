...
class FFT_ionS():
    ...
    #def __init__(self, filename, massRange=[5, 50], dcRange=2, cal_mass=[17,18], cal_pixel=[197,279]):
        ...
        self.filepath = []
        self.rootPath= pl.PureWindowsPath(r'D:\Data_newTOF')
        ...
        self.stage = 'piezo'
        self.savePath = os.path.join(self.rootPath, r'dataProcessing', r'H2', str(self.intensity)+'_'+self.molecule)
    ...
    def calDrift2(self, _cRange, gas='Ch2'):
        ...
        _iS2 = np.array(np.zeros(self.interSpectraBottleB[gas].shape))
        for i in range(self.interSpectraBottleB[gas].shape[0]):
            _iS[i]=self.butter_bandpass_filter(self.interSpectraBottleB[gas][i], (4161.07887-20)/33.35641*1e12, (4161.07887+20)/33.35641*1e12, 1/(self.delayB[1]-self.delayB[0]))
