...
class FFT_ionS():
    ...
    #def __init__(self, filename, massRange=[5, 50], dcRange=2, cal_mass=[17,18], cal_pixel=[197,279]):
        ...
        self.delay = np.arange(self.scanLength)/self.scanLength*(116.7/119)*94*2*3.33564*10**-15
...
if __name__ == '__main__':
    ...
    #date, filename, firstTry, sumNo, usefulRange, cu = [r'2021-10-14', r'scan_tof_2021-10-14-09-48-02', False, 36, [0,1], False]#80-90 35 Ar #spectra has blue drift
    ...
    #date, filename, firstTry, sumNo, usefulRange, cu = [r'2021-10-13', r'scan_tof_2021-10-13-16-36-09', False, 36, [0,1], False]#100-100 35 Ar try again later.
    #date, filename, firstTry, sumNo, usefulRange, cu = [r'2021-10-13', r'scan_tof_2021-10-13-14-53-44', False, 36, [0,1], False]#80-100 35 Ar
    ...
    #date, filename, firstTry, sumNo, usefulRange, cu = [r'2021-10-13', r'scan_tof_2021-10-13-21-40-53', False, 15, [0,5], False]#60-80 250 Ar #probe 80 is too low
