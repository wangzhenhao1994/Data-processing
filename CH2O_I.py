...
class FFT_ionS():
    ...
    def __init__(self, filename, scanTime, sampRate, massRange=[5, 50], molecule='CH2O', intensity = 0, dcRange=5, ChN=11, cal_mass=[2,16], cal_pixel=[3082,10216], direction = 'left'):
    ...
    #def __init__(self, filename, massRange=[5, 50], dcRange=2, cal_mass=[17,18], cal_pixel=[197,279]):
        ...
        self.stage = 'piezo'
        self.savePath = os.path.join(self.rootPath,r'CH2O', str(self.intensity)+'_'+self.molecule)
        ...
        for file in files:
            if '.txt' in file:
                with open(os.path.join(root, file), 'r') as f:
                    a = f.read()
                    if r'Ch10 is the reference of Ch4 and Ch6' in a:
                        ...
                        intensity.reverse()
                        ff=ff+[FFT_ionS(filename=[fname], scanTime=10, sampRate=300, molecule='CH2O', intensity=intensity,ChN=11)]
...
#
    #f7 = FFT_ionS(filename=f7, scanTime=10, sampRate=300, molecule='CH2O', intensity=[cal_intensity(250,9,5),cal_intensity(70,19.5,5)],ChN=11)
    #f8 = FFT_ionS(filename=f8, scanTime=10, sampRate=300, molecule='CH2O', intensity=[cal_intensity(210,10,5),cal_intensity(70,19.5,5)],ChN=11)
    #f9 = FFT_ionS(filename=f9, scanTime=10, sampRate=300, molecule='CH2O', intensity=[cal_intensity(170,12,5),cal_intensity(70,19.5,5)],ChN=11)
    #f10= FFT_ionS(filename=f10, scanTime=10, sampRate=300, molecule='CH2O', intensity=[cal_intensity(130,14.5,5),cal_intensity(70,19.5,5)],ChN=11)
    #f11= FFT_ionS(filename=f11, scanTime=10, sampRate=300, molecule='CH2O', intensity=[cal_intensity(70,19.5,5),cal_intensity(250,9,5)],ChN=11)
    #f12= FFT_ionS(filename=f12, scanTime=10, sampRate=300, molecule='CH2O', intensity=[cal_intensity(70,19.5,5),cal_intensity(210,10,5)],ChN=11)
    #f13= FFT_ionS(filename=f13, scanTime=10, sampRate=300, molecule='CH2O', intensity=[cal_intensity(70,19.5,5),cal_intensity(170,12,5)],ChN=11)
#
    #f14= FFT_ionS(filename=f14, scanTime=10, sampRate=300, molecule='CH2O', intensity=[cal_intensity(170,12,5),cal_intensity(120,13.5,5)],ChN=11)
    #f15= FFT_ionS(filename=f15, scanTime=10, sampRate=300, molecule='CH2O', intensity=[cal_intensity(170,12,5),cal_intensity(150,12,5)],ChN=11)
    #f16= FFT_ionS(filename=f16, scanTime=10, sampRate=300, molecule='CH2O', intensity=[cal_intensity(170,12,5),cal_intensity(180,10.5,5)],ChN=11)
    #f17= FFT_ionS(filename=f17, scanTime=10, sampRate=300, molecule='CH2O', intensity=[cal_intensity(170,12,5),cal_intensity(210,10,5)],ChN=11)
    #f18= FFT_ionS(filename=f18, scanTime=10, sampRate=300, molecule='CH2O', intensity=[cal_intensity(170,12,5),cal_intensity(250,9,5)],ChN=11)
    #f19= FFT_ionS(filename=f19, scanTime=10, sampRate=300, molecule='CH2O', intensity=[cal_intensity(250,8.4,5),cal_intensity(270,8.4,5)],ChN=11)
