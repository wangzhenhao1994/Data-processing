...
TM_Method=0;Ns=0;       % Transfer Matrix Method (TMM), Ns=number of segment per layer !!!WORK ONLY with Pot_MultiLayers!!!
...
dz=5.29177210903*1e-14;               % resolution of the grid [m]
n=5;                   % number of solution asked 

Mass = 0.5*1836.15267343;           % effective mass, constant over all the structure...
...
display(strcat('E(cm-1)='))
display(strcat(num2str(E*8065.54429)))
