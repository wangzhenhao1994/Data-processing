...
prt.disp ('Minima Realization and Model Reduction (MRMR)')
prt.disp ('=============================================')
prt.disp ('   ')
...
prt.disp ([int2str(n_S) ' states are controllable and observable'])
% Sigma_2: controllable but not observable
prt.disp ([int2str(n_P-n_S) ' states are controllable but not observable'])
