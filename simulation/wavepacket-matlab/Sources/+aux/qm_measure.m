...
prt.disp (' ')
prt.disp ('-------------------------------------------------------------')
prt.disp (' Reads the solution x_t from bilinear control equation and   ')
prt.disp (' undoes balanced truncation transformation and               ')
prt.disp (' reconstructs the density operator (in matrix form) and      ')
prt.disp (' calculates various correlation measures                     ')
prt.disp ('                                                             ')
prt.disp ('-------------------------------------------------------------')
prt.disp (' ')
