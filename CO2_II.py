...
class FFT_ionS():
    ...
    def show_FFT(self):
        self.dcRange=0
        fig, ax = plt.subplots(nrows=2, ncols=2, sharex=True, sharey=True,figsize=(18,9))
        ...
        for gas in ['Ch8','Ch2','Ch4','Ch6']:
            ...
            if gas == 'Ch8':
                peaks, _ = sps.find_peaks(Y_window[0],width=10,prominence=0.1,distance=1,height=0.1)
